...
class TransactionSyncService
{
    ...
    public function markSyncCompleted(
        ...
        // Mismatched statement/balance evidence fails closed: the run is not a
        // completeness success. Unavailable evidence is retained and surfaced,
        // but does not by itself claim a match.
        if ($evidence instanceof StatementBalanceEvidence) {
            ...
            // Legacy callers (marker-only tests) may omit evidence; do not invent
            // a completeness claim, but also do not rewrite their run outcome.
